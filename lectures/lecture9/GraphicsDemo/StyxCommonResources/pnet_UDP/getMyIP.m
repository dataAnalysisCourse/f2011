...
%
% Purpose			
%			This function is developed for the pnet UDP receieve
%			command sequence
...
%
% copyright 2008 John D. Simeral, All Rights Reserved
% -------------------------------------------------------------------------

% get a long DOS report of IP configuration information
a=(strread(evalc('!ipconfig'),'%s','delimiter','\n'));

if ~nargin 
	% Report all unique IPv4 addresses

	% capture the lines whith IPv4 addresses
