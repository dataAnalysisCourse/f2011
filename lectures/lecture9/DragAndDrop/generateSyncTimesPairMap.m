...
pairMapTimes = cell(ncells, ncells, nwind, 2); % event times for each cell pair and window
pairMapParams = cell(ncells, ncells, nwind, 2); % fitted RF params for each cell pair and window
pairMapTWind = twind; % timing windows used to create these events
...
rf.pairMapTimes = pairMapTimes;
rf.pairMapCindex = pairMapCindex;
