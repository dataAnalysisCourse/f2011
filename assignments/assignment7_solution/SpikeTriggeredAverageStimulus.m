...
%
% INPUTS:
%       spikeTimesFile        Filename of .mat file containing <spikeTimes> vector 
%                             of recorded spike times of this cell.
%       stimFile              Filename of .mat file containing <stim> structure
...
function [STA numSpikesUsed tau] = SpikeTriggeredAverageStimulus( spikeTimesFile, stimFile, tau, ignoreFirstNms )
    % ********************************************************************
    %                     OPTIONAL ARGUMENTS
    % ********************************************************************
    if nargin < 3
    ...
    % YOU DO NOT NEED TO IMPROVE THIS FUNCTION; IT'S JUST TO SHOW YOU WHAT THE RAW DATA
    % LOOK LIKE
